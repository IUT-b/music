...
const TrackTable = ({ title, tracks, onCheckboxChange }: TrackTableProps) => (
  <div className="mt-6">
      ...
      <table className="min-w-full table-auto text-left text-sm text-gray-500 dark:text-gray-400">
        <thead className="bg-gray-50 dark:bg-gray-700">
          <tr>
            ...
            <th scope="col" className="px-6 py-3 font-medium text-gray-900 dark:text-white"></th>
          </tr>
        </thead>
            ...
            <tr className="border-b border-gray-200 dark:border-gray-600" key={index}>
              ...
              <td className="px-6 py-4">
                <Checkbox
                  ...
                  onChange={(checked) => onCheckboxChange(track.id, checked)}
                />
              </td>
            </tr>
          ))}
